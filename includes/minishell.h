...
/*   Updated: 2025/04/16 16:42:37 by tboulogn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char		**prepare_envp(t_args *args, t_env *env,
				t_pipe *pro, char **cmd_tab);
...
void		child_process(t_args *temp, t_cmd *cmd,
				t_env *env_list, t_pipe pro);
//pipe.c//
